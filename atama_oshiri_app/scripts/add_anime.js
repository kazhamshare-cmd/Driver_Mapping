...
const animeList = [
  'えゔぁんげりおん', 'ほくとのけん', 'さざえさん', 'きめつのやいば',
  'どらえもん', 'なると', 'おねがいぷれいやー', 'あたっくおんたいたん',
  'ふぃんがる', 'すぱいかーまん', 'あくせるわーるど', 'しんせきのきょうだい',
  'きみのなまえ', 'てんきのこ', 'ぱんぱん', 'ゆうしゃよしひこ',
  'まじょのたび', 'きゅうべえ', 'あいまん', 'ぱんぱんぱん',
  'きゅうべえ', 'あいまん', 'ぱんぱんぱん', 'きゅうべえ',
  'あいまん', 'ぱんぱんぱん', 'きゅうべえ', 'あいまん'
];
...
function main() {
  console.log('有名アニメ作品を追加中...');
  
  const categories = {};
  
  animeList.forEach(word => {
    if (word.length >= 3) {
